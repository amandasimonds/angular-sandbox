...
public class StyleDictionaryClass {
    public static let colorBaseGrayDark = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1)
    public static let colorBaseGrayLight = UIColor(red: 0.263, green: 0.263, blue: 0.263, alpha: 1)
    public static let colorBaseGrayMedium = UIColor(red: 0.867, green: 0.867, blue: 0.867, alpha: 1)
    ...
    public static let colorFontTertiary = UIColor(red: 0.263, green: 0.263, blue: 0.263, alpha: 1)
